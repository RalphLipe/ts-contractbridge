...
1. Contract + Contract.Risk — bid + normal/doubled/redoubled
2. Auction — struct tracking calls, dealer, declared contract
3. DeclaredContract — declarer + contract
