...
export namespace DoubleDummyTable {
  export const make = (): DoubleDummyTable => ({ N: {}, E: {}, S: {}, W: {} })

  export const withTricks = (
  ...
  export const pbn = (dd: DoubleDummyTable): string => {
    let result = ''
  ...
  export const fromPBN = (s: string): DoubleDummyTable | undefined => {
  ...
  export const rotated = (dd: DoubleDummyTable, seats: number): DoubleDummyTable => {
